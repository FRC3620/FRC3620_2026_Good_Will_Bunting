...
public class DepotDeepState extends SuperState {
    ...
    Command doEverythingCommand = new AutoAimShooterCommand(ShotCalculator.FieldTargets.DEPOT_DEEP_PASS.getTargetPositionSupplier());
    ...
    public void onEnter() {
        ...
        RobotContainer.setActiveTarget(ShotCalculator.FieldTargets.DEPOT_DEEP_PASS);

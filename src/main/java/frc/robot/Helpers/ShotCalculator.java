...
public class ShotCalculator {
        ...
        public enum FieldTargets {
                ...
                DEPOT_CORNER(new Translation3d(Meters.of(4.054), Meters.of(8.2-1.410), Inches.of(0))),
                ...
                public Supplier<Translation3d> getTargetPositionSupplier() {
        ...
        public static Distance calculateBaseHDistanceToTarget(Supplier<Translation2d> targetPosition,
                ...
                Distance distance = Meters.of(targetPosition.get().getDistance(turretPosition));
                                ...
                                ratio
                                                * Math.sqrt(
                                                                (32.2 * (deltaZ.in(Feet) + Math.sqrt(
                                                                                Math.pow(hDistance.in(Feet), 2) + Math
                                                                                                .pow(deltaZ.in(Feet),
                                                                                                                2))))));
        ...
        public static VelocityVector calculateRobotVelocity(SwerveDriveKinematics kinematics,
                ...
                VelocityVector velocity = new VelocityVector(
                                FeetPerSecond.of(Feet.convertFrom(fieldRelativeSpeeds.vxMetersPerSecond, Meters))
                                                .times(xMultiplier),
                                FeetPerSecond.of(Feet.convertFrom(fieldRelativeSpeeds.vyMetersPerSecond, Meters))
                                                .times(yMultiplier));

                SmartDashboard.putNumber("frc3620/ShotCalculator/RobotVelocityFtps",
                                velocity.getNorm().in(FeetPerSecond));
                SmartDashboard.putNumber("frc3620/ShotCalculator/RobotVelocityXFtps",
        ...
        public static VelocityVector calculateQuestVelocity(LinearVelocity questVX, LinearVelocity questVY,
                ...
                SmartDashboard.putNumber("frc3620/ShotCalculator/RobotQVelocityFtps",
                                velocity.getNorm().in(FeetPerSecond));
                SmartDashboard.putNumber("frc3620/ShotCalculator/RobotQVelocityXFtps",
                                velocity.getX().in(FeetPerSecond));
                SmartDashboard.putNumber("frc3620/ShotCalculator/RobotQVelocityYFtps",
                                velocity.getY().in(FeetPerSecond));

                return velocity;
        }

        public static Angle calculateFieldAngle(Supplier<Translation3d> targetPosition,
                        Supplier<Pose2d> robotPose, Supplier<VelocityVector> robotVelocity) {

                VelocityVector netHorizontalVelocity = calculateNetHorizontalVelocity(targetPosition, robotPose,
                                robotVelocity);
        ...
        public static Angle calculateExitAngle(Supplier<Translation3d> targetPosition,
                        Supplier<Pose2d> robotPose,
                        Supplier<VelocityVector> robotVelocity) {
                VelocityVector netHorizontalVelocity = calculateNetHorizontalVelocity(targetPosition, robotPose,
                                robotVelocity);
                LinearVelocity netVerticalVelocity = calculateNetVerticalVelocity(targetPosition, robotPose,
                                robotVelocity);
        ...
        public static Angle calculateExitAngleFromActualSpeed(
                        Supplier<Translation3d> targetPosition,
                        Supplier<Pose2d> robotPose,
                        Supplier<VelocityVector> robotVelocity,
        ...
        public static Angle calculateHoodAngle(
                ...
                // Fall back to theoretical calculation if shooter isn't spinning yet
                if (actualShooterSpeed.get().in(RevolutionsPerSecond) < 5.0) {
                        Angle fallback = Degrees.of(100).minus(
                                        calculateExitAngle(targetPosition, robotPose, robotVelocity));
                        SmartDashboard.putNumber("frc3620/ShotCalculator/FinalHoodAngleFromActualRaw",
                                        fallback.in(Degrees));
                ...
                Angle rawHoodAngle = Degrees.of(100).minus(
                                calculateExitAngleFromActualSpeed(targetPosition, robotPose, robotVelocity,
                                                actualShooterSpeed));
                ...
                smoothedHoodAngle = Degrees
                                .of(smoothEMA(rawHoodAngle.in(Degrees), smoothedHoodAngle.in(Degrees), HOOD_ALPHA));
                SmartDashboard.putNumber("frc3620/ShotCalculator/FinalHoodAngleFromActualRaw",
                                rawHoodAngle.in(Degrees));
                SmartDashboard.putNumber("frc3620/ShotCalculator/FinalHoodAngleFromActualSmooth",
        ...
        public static LinearVelocity calculateNetVerticalVelocity(Supplier<Translation3d> targetPosition,
                        Supplier<Pose2d> robotPose,
                        Supplier<VelocityVector> robotVelocity) {
                LinearVelocity verticalExitVelocity = FeetPerSecond
                                .of(calculateBaseExitVelocity(targetPosition, robotPose).in(FeetPerSecond)
                                                * Math.sin(calculateHighBaseExitAngle(targetPosition, robotPose)
                                                                .in(Radians)));
                ...
                SmartDashboard.putNumber("frc3620/ShotCalculator/NetVerticalShotVZ",
                                verticalVelocity.in(FeetPerSecond));
        ...
        public static LinearVelocity calculateNetShotVelocity(Supplier<Translation3d> targetPosition, Supplier<Pose2d> robotPose,
                ...
                SmartDashboard.putNumber("frc3620/ShotCalculator/NetShotMagnitude",
                                netShot.getNorm().in(FeetPerSecond));
        ...
        public static void publishShotData(
                        Supplier<Pose2d> robotPose,
                        Supplier<VelocityVector> robotVelocity,
                        Supplier<FieldTargets> currentTarget,
                        Supplier<AngularVelocity> currentShooterSpeed,
                        Supplier<Angle> currentTurretAngle) {
                Translation3d target = currentTarget.get().getTargetPositionSupplier().get();
